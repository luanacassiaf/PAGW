...
<div class="ml-1 d-flex justify-content-center align-items-center">
    ...
    <div class="btn-group">
        <button id="btn-executar" class="btn btn-success" type="button" onclick="executarAlgoritmoBfs()"><i class="fa fa-play"></i> Executar</button>
    </div>
</div>

<script>
var grafo = new Bfs('grafo');

function executarAlgoritmoBfs() {
